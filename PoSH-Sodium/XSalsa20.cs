...
{
    [Cmdlet("Encrypt", "XSalsaMessage")]
    public class XSalsaEncrypt : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            var encryptedMessage = StreamEncryption.Encrypt(rawMessage, nonce, Key);
            if (Raw.IsTrue())
            {
    ...
    [Cmdlet("Decrypt", "XSalsaMessage")]
    public class XSalsaDecrypt : PSCmdlet
    {
        protected override void BeginProcessing()
        {
    ...
    [Cmdlet("Decrypt", "RawXSalsaMessage")]
    public class RawXSalsaDecrypt : PSCmdlet
    {
        protected override void ProcessRecord()
        {
            byte[] message;
            message = StreamEncryption.Decrypt(Message, Nonce, Key);
            if (Raw.IsTrue())
            {
                WriteObject(message);
            }
